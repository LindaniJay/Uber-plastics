    ...
    return [
      {
        ...
        headers: [
          ...
          ...(isProduction ? [{
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; font-src 'self' data:; connect-src 'self' https://storage.googleapis.com; worker-src 'self' blob:;"
          }] : [{
            key: 'Content-Security-Policy',
            value: "default-src 'self' 'unsafe-eval' 'unsafe-inline' data: blob:; script-src 'self' 'unsafe-eval' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob:; font-src 'self' data:; connect-src 'self' http: https: ws: wss: https://storage.googleapis.com http://localhost:8000; worker-src 'self' blob:;"
          }])
        ]
      },
