...
export function AuthNavbar() {
  ...
  if (!isAuthenticated) {
    return (
      <nav className="bg-transparent py-4 content-fit">
        <div className="container-fit">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2 bg-gray-800/80 backdrop-blur-sm rounded-full px-4 py-2 border border-gray-600/30">
              <Link
                href="/"
    ...
    <nav className="bg-transparent py-4 content-fit">
      <div className="container-fit">
        <div className="flex justify-between items-center">
          ...
          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-2 bg-gray-800/80 backdrop-blur-sm rounded-full px-4 py-2 border border-gray-600/30">
            <Link
              href="/"
              className="flex items-center space-x-2 text-gray-300 hover:text-white hover:bg-gray-700/50 px-3 py-2 rounded-full transition-all duration-200"
            >
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-2 px-3 py-2 bg-gray-800/80 backdrop-blur-sm rounded-full border border-gray-600/30">
        ...
        {isOpen && (
          <motion.div
            ...
            className="md:hidden mt-4 bg-gray-800/80 backdrop-blur-sm rounded-2xl border border-gray-600/30 mx-4"
          >
